...
namespace Adventure
{
  public class Program
  {
    public static void Main()
    {
      ...
      Branches X1A2 = new Branches("mirror room", "You wake up in your bedroom", "2nd visit", "movement choice", 7, false, false);
      ...
      Branches X1A2A = new Branches("happy reflection", "You wake up in your bedroom", "2nd visit", "movement choice", 9, false, false);
      
      Branches X1A2AB = new Branches("sad reflection", "You wake up in your bedroom", "2nd visit", "movement choice", 10, false, false);
      
      Branches X1B1 = new Branches("cellar", "You wake up in your bedroom", "2nd visit", "movement choice", 11, false, false);
      ...
      Branches X1B1A = new Branches("dungeon", "You wake up in your bedroom", "2nd visit", "movement choice", 13, false, false);
